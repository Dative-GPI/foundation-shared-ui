import{d as G,c as E,B as h,J as g,E as f,z as y,A as he,K as Fe,m as ee,I as k,b as m,C as U,F as D,S as Le,q as K,R as Z,H as F,Y as oe,a1 as te,U as ke,O as I,V as Te,i as j,w,a8 as _e,p as Ce,D as He,P as Ue,Q as De}from"./vue.esm-bundler-CqZ6aK3I.js";import{a as je}from"./properties-Qw-O9fbT.js";import{l as c}from"./leaflet-src-CVI3lIVZ.js";import{F as Qe}from"./FSClickable-CBfoSsDs.js";import{_ as $e}from"./FSSpan-B7HDTlg9.js";import{_ as C}from"./FSRow-udQVJR1p.js";import{_ as z}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{F as O}from"./FSButton-2OKi08_r.js";import{F as Ke}from"./FSDialog-DMj4MxEk.js";import{F as we}from"./FSCard-BH9I8ruU.js";import{F as Ie}from"./FSIcon-8KcAAKgU.js";import{F as P}from"./FSCol-DIPgj7wU.js";import{M as b,a as M}from"./map-Cp2HcdwH.js";import{u as Pe}from"./useBreakpoints-DMrtgY61.js";import{V as Je}from"./VOverlay-CrPt6Ctk.js";import{u as qe,C as N}from"./useColors-BIkRBR7C.js";import{u as Ye}from"./useTranslations-D4m4SVfo.js";import{u as Xe}from"./useSlots-BgbXyH5p.js";import{_ as ea}from"./FSFadeOut-B817LR1t.js";import{u as aa}from"./uuid-DTaye2KM.js";import"./_commonjsHelpers-BosuxZz1.js";import"./FSRouterLink-CyH3F3Zz.js";import"./vue-router-RJKW7Wfw.js";import"./css-BZjDzSZ1.js";import"./VProgressCircular-cB7gdjsO.js";import"./color-iZFxpsFf.js";import"./theme-CCooKRqg.js";import"./resizeObserver-C7qOORSR.js";import"./VIcon-ZzEkeSRE.js";import"./FSText-C92q1_nI.js";import"./VDialog-BjO_95QL.js";import"./forwardRefs-DWGaNmQL.js";import"./proxiedModel-BirLikdP.js";import"./scopeId-BQSHBqq_.js";import"./VDefaultsProvider-3cG3_dFO.js";import"./anchor-DiyvyHyx.js";import"./dimensions-CuS7VcMO.js";import"./display-Cs3Y1ygD.js";import"./locale-BJmdjC_5.js";import"./router-C0dK7NvB.js";import"./transition-C13qRIR1.js";import"./index-DfSX31J9.js";const na=(e,a,l="")=>`
  ...
  <div class="fs-map-cluster">
    <span>${e}</span>
      ...
      `})},W={args:{currentLayer:b.Imagery,overlayMode:M.Half},render:e=>({components:{FSMap:R,FSFadeOut:ea,FSRow:C,FSCol:P,FSMapMarker:V,FSMapMarkerClusterGroup:J},setup(){const a=m(null);return{args:e,locations:Q,bounds:a}},template:`
      <FSMap
        v-model:overlayMode="args.overlayMode"
        v-model:currentLayer="args.currentLayer"
        v-model:selectedLocationId="args.selectedLocationId"
    ...
    `})},T={args:{currentLayer:b.Snow,allowedLayers:[b.Map,b.Imagery,b.Snow],grayscale:!1,enableScrollWheelZoom:!0},render:e=>({components:{FSMap:R,FSMapMarker:V,FSMapMarkerClusterGroup:J},setup(){const a=m(null);return{args:e,bounds:a}},template:`
      <FSMap
        v-model:currentLayer="args.currentLayer"
        :bounds="bounds"
        v-bind="args"
