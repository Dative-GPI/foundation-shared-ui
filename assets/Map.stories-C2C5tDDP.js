import{e as i,W as O,a as z,p as N,S as Q,d as H}from"./vue.esm-bundler-D_gXonxt.js";import{a as j}from"./properties-Qw-O9fbT.js";import{c as U,M as q,F as m,a as c}from"./FSMap-DIMOAPh2.js";import{F as J}from"./FSCol-C3EJfcJX.js";import{_ as $}from"./FSRow-cHWWqhhs.js";import{_ as V}from"./FSFadeOut-z7-cnvK3.js";import{a as f}from"./leaflet-src-CCqwBO6N.js";import{_ as D}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{F as K}from"./FSButton-DHeuA-BH.js";import{M as s,a as u}from"./map-CqFLeMuy.js";import{u as T}from"./uuid-DTaye2KM.js";import"./FSCard-Cxfe3-O9.js";import"./FSRouterLink-DcR6eU1F.js";import"./vue-router-v2CeLf7E.js";import"./useColors-B49MKafH.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./theme-DdZUMbNR.js";import"./css-Bznx04uW.js";import"./useBreakpoints-BWz07CZT.js";import"./VProgressCircular-BomUTxjq.js";import"./color-DuOnfdFp.js";import"./useRender-BE0GCWmZ.js";import"./intersectionObserver-Dxvbt_ZY.js";import"./resizeObserver-B9WvY7yr.js";import"./size-WKyNI-v9.js";import"./tag-CbMfyUQg.js";import"./FSSpan-ap0CpdXZ.js";import"./useSlots-CdBAzqCX.js";import"./FSDialog-DYg9zjQ-.js";import"./FSText-DL_5kFi7.js";import"./VDialog-BTFeiENf.js";import"./VOverlay-CrMgAm2W.js";import"./proxiedModel-Cl0bR0rs.js";import"./easing-DY7PVvcf.js";import"./anchor-DrPAsKKU.js";import"./dimensions-BYDjhYdL.js";import"./display-BIN9xr9Q.js";import"./lazy-aXB44k01.js";import"./locale-CEMLpecI.js";import"./router-hLwSEJDL.js";import"./scopeId-BwxBN6Au.js";import"./transition-CHyhkthg.js";import"./forwardRefs-C-GTDzx5.js";import"./dialog-transition-d5ANZlFh.js";import"./VDefaultsProvider-DJfojugM.js";import"./FSIcon-B9MXbR5l.js";import"./VIcon-gCapjdof.js";import"./icons-DiQlgRdj.js";import"./iframe-CLWs4VJc.js";import"./useTranslations-D2TwtVAp.js";const W={name:"FSMapMarkerClusterGroup",props:{expectedLayers:{type:Number,default:0,required:!1},disableClusteringAtZoom:{type:Number,default:17,required:!1}},setup(n,{emit:a}){const o=z(q);let r=!1;if(!o)throw new Error("FSMapMarkerClusterGroup must be used inside a FSMap component");if(!o.value)throw new Error("FSMapMarkerClusterGroup must be used inside a FSMap component with a map");const t=i(new f.MarkerClusterGroup({spiderfyOnMaxZoom:!1,showCoverageOnHover:!1,disableClusteringAtZoom:n.disableClusteringAtZoom,iconCreateFunction:function(e){return f.divIcon({html:U(e.getChildCount()),className:"fs-map-marker fs-map-cluster-marker",iconSize:[36,36],iconAnchor:[36/2,36/2]})}}));N("markerClusterGroup",t);const d=()=>{if(!o.value)return;const e=t.value.getLayers();if(e.length===0&&r){o.value.removeLayer(t.value),r=!1;return}if(e.length===n.expectedLayers&&!r&&(t.value.addTo(o.value),r=!0),e.length===n.expectedLayers){const l=new f.LatLngBounds([]);for(const p of e)p.getBounds?l.extend(p.getBounds()):p.getLatLng&&l.extend(p.getLatLng());a("update:bounds",e.length>0?l:null)}};t.value.on("layeradd",d),t.value.on("layerremove",d),O(()=>{o.value&&o.value.hasLayer(t.value)&&o.value.removeLayer(t.value)})}};function X(n,a,o,r,t,d){return Q(n.$slots,"default")}const S=D(W,[["render",X]]);W.__docgenInfo={displayName:"FSMapMarkerClusterGroup",exportName:"default",description:"",tags:{},props:[{name:"expectedLayers",type:{name:"number"},required:!1,defaultValue:{func:!1,value:"0"}},{name:"disableClusteringAtZoom",type:{name:"number"},required:!1,defaultValue:{func:!1,value:"17"}}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/foundation-shared-ui/foundation-shared-ui/src/shared/foundation-shared-components/components/map/FSMapMarkerClusterGroup.vue"]};const De={title:"Foundation/Shared/Map",component:c,tags:["autodocs"],argTypes:{...j(c),currentLayer:{control:"select",options:[s.Map,s.Imagery,s.Snow]},overlayMode:{control:"select",options:[u.Expand,u.Half,u.Collapse]}}},b=[{id:"3fb7ebf0-3227-4767-bb96-001384efdd57",label:"Le Mans GERAL",address:{formattedAddress:"Bd Marie et Alexandre Oyon, 72100 Le Mans, France",locality:"Le Mans",country:"France",latitude:47.9946047,longitude:.1907672,placeId:"EjJCb3VsZXZhcmQgTWFyaWUgZXQgQWxleGFuZHJlIE95b24sIExlIE1hbnMsIEZyYW5jZSIuKiwKFAoSCZdY4sE2j-JHEfQHbY7RQXwpEhQKEgkxqvMU0ojiRxF_4H1qTF0CaQ",placeLabel:"Boulevard Marie et Alexandre Oyon, Le Mans, France"},icon:null,color:null},{id:"83963f32-6bd5-453d-b271-2b5a41672966",label:"Dative GPI",icon:"mdi-laptop",color:"#FF0000",address:{formattedAddress:"100 rue de norvège, Colombier Saugnieu, France",locality:"Colombier Saugnieu",country:"France",latitude:45.71175,longitude:5.071489,placeId:"",placeLabel:"Dative, France"}},{id:"44e00e4b-ef50-4f88-9fb2-d94659ee5881",label:"Gerard Perrier Industrie",icon:"mdi-home",color:"primary",address:{formattedAddress:"160 rue de norvège, Colombier Saugnieu, France",locality:"Colombier Saugnieu",country:"France",latitude:45.71129,longitude:5.071729,placeId:"",placeLabel:"GPI, France"}},{id:"4a3ced7a-d7e7-4004-b40a-ed57fa45615d",label:"Seirel Automatismes SAS",icon:"mdi-snowflake",color:"#FF0000",address:{formattedAddress:"7 Rue Galilée, 69800 Saint-Priest, France",locality:"Saint-Priest",country:"France",latitude:45.682349,longitude:4.956942,placeId:"",placeLabel:"Seirel, France"}},{id:"0598187c-3c63-413c-bc82-86c279027955",label:"D.E.S. FRIUL DI MIEC",address:{formattedAddress:"Via Ermes di Colloredo, 33040 Salt UD, Italie",locality:"Salt",country:"Italie",latitude:46.1158765,longitude:13.2881119,placeId:"EjBWaWEgRXJtZXMgZGkgQ29sbG9yZWRvLCBQb3ZvbGV0dG8sIFVkaW5lLCBJdGFsaWUiLiosChQKEgl_rhjEJEp6RxGWfpMrWhzPkBIUChIJn70qOztKekcRlT3jhsw1_cY",placeLabel:"Via Ermes di Colloredo, Povoletto, Udine, Italie"}}],g={args:{overlayMode:u.Collapse,currentLayer:s.Map,height:"100%",width:"100%",grayscale:!1,showMyLocation:!0,showZoomButtons:!0,enableScrollWheelZoom:!0},render:n=>H({components:{FSMap:c,FSRow:$,FSMapMarker:m},inheritAttrs:!1,setup(){const a=i(b[0]);return{args:n,location:a,onNewClick:r=>{console.log(r),a.value.address.latitude=r.lat,a.value.address.longitude=r.lng}}},template:`
        <FSRow height="500px">
          <FSMap
      ...
      `})},v={args:{currentLayer:s.Imagery,overlayMode:u.Half},render:n=>({components:{FSMap:c,FSFadeOut:V,FSRow:$,FSCol:J,FSMapMarker:m,FSMapMarkerClusterGroup:S},setup(){const a=i(null);return{args:n,locations:b,bounds:a}},template:`
      <FSMap
        v-model:overlayMode="args.overlayMode"
        v-model:currentLayer="args.currentLayer"
        v-model:selectedLocationId="args.selectedLocationId"
    ...
    `})},M={args:{currentLayer:s.Snow,allowedLayers:[s.Map,s.Imagery,s.Snow,s.OpenStreetMap],grayscale:!1,enableScrollWheelZoom:!0},render:n=>({components:{FSMap:c,FSMapMarker:m,FSMapMarkerClusterGroup:S},setup(){const a=i(null);return{args:n,bounds:a}},template:`
      <FSMap
        v-model:currentLayer="args.currentLayer"
        :bounds="bounds"
        v-bind="args"
    ...
    `})},F={args:{enableScrollWheelZoom:!0},render:n=>({components:{FSMap:c,FSMapMarker:m,FSMapMarkerClusterGroup:S,FSButton:K},setup(){const a=i([]),o=i(null);return{args:n,pins:a,bounds:o,addRandomPin:()=>{const d=Math.floor(Math.random()*b.length),e=b[d],p={id:T(),label:`Pin ${a.value.length+1}`,latitude:e.address.latitude+Math.random()*10-5,longitude:e.address.longitude+Math.random()*10-5};a.value.push(p)},removePin:d=>{const e=a.value.findIndex(l=>l.id===d);e!==-1&&a.value.splice(e,1)}}},template:`
      <FSMap
        v-model:currentLayer="args.currentLayer"
        :bounds="bounds"
        v-bind="args"
...
}`,...(_=(B=F.parameters)==null?void 0:B.docs)==null?void 0:_.source}}};const Ke=["SingleLocationMap","MultiLocationMap","CustomPinMap","ClickablePinMap","GeneratePinMap"];export{y as ClickablePinMap,M as CustomPinMap,F as GeneratePinMap,v as MultiLocationMap,g as SingleLocationMap,Ke as __namedExportsOrder,De as default};
