import{e as i,W as _,a as z,p as N,S as Q,d as H}from"./vue.esm-bundler-C5-CUMHT.js";import{a as j}from"./properties-Qw-O9fbT.js";import{c as U,M as q,F as m,a as c}from"./FSMap-S96bCmAZ.js";import{F as J}from"./FSCol-DedFW0nl.js";import{F as W}from"./FSRow-C8aYwBu-.js";import{_ as V}from"./FSFadeOut-DOLGFW1u.js";import{a as S}from"./leaflet-src-Dw1OyN9w.js";import{_ as D}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{F as K}from"./FSButton-DohpVEzP.js";import{M as s,a as u}from"./map-B32CpSfc.js";import{u as T}from"./uuid-DTaye2KM.js";import"./FSCard-DYe1QD8j.js";import"./FSRouterLink-CMTOFxCD.js";import"./vue-router-Bg3goQnP.js";import"./useColors-BAnxS_-e.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./theme-CB6As9Cd.js";import"./css-DSFbdPon.js";import"./useBreakpoints-pPMhsL5T.js";import"./VProgressCircular-D7Gk7a1O.js";import"./color-D7ZCcSxD.js";import"./useRender-_COxrB9K.js";import"./intersectionObserver-D1RZdbEq.js";import"./resizeObserver-hE1ulDL8.js";import"./size-DwliOKuO.js";import"./tag-enhOFdJJ.js";import"./FSSpan-D6aG51_c.js";import"./useSlots-ol4Nk6ew.js";import"./FSDialog-BXShlDnV.js";import"./FSText-C8rmUTxK.js";import"./VDialog-CSacG24V.js";import"./VOverlay-CG3iG1zZ.js";import"./proxiedModel-CV-HTW34.js";import"./easing-DY7PVvcf.js";import"./anchor-Dj2AEc5N.js";import"./dimensions-Bm76csmg.js";import"./display-IUfV935l.js";import"./lazy-DXVvciW4.js";import"./locale-BNkeanE6.js";import"./router-CTGX-puL.js";import"./scopeId-DKs4U9S0.js";import"./transition-CgRUW3r8.js";import"./forwardRefs-C-GTDzx5.js";import"./dialog-transition-DRDndVEC.js";import"./VDefaultsProvider-Dy-3lUkF.js";import"./FSIcon-CNpmwcOd.js";import"./VIcon-IlEzlDWp.js";import"./icons-CucLNLjN.js";import"./iframe-Cg3k6e0_.js";import"./useTranslations-DAi7IZoP.js";import"./eventQueue-D85hWBFd.js";const O={name:"FSMapMarkerClusterGroup",props:{expectedLayers:{type:Number,default:0,required:!1},disableClusteringAtZoom:{type:Number,default:17,required:!1}},setup(n,{emit:a}){const o=z(q);let r=!1;if(!o)throw new Error("FSMapMarkerClusterGroup must be used inside a FSMap component");if(!o.value)throw new Error("FSMapMarkerClusterGroup must be used inside a FSMap component with a map");const t=i(new S.MarkerClusterGroup({spiderfyOnMaxZoom:!1,showCoverageOnHover:!1,disableClusteringAtZoom:n.disableClusteringAtZoom,iconCreateFunction:function(e){return S.divIcon({html:U(e.getChildCount()),className:"fs-map-marker fs-map-cluster-marker",iconSize:[36,36],iconAnchor:[36/2,36/2]})}}));N("markerClusterGroup",t);const d=()=>{if(!o.value)return;const e=t.value.getLayers();if(e.length===0&&r){o.value.removeLayer(t.value),r=!1;return}if(e.length===n.expectedLayers&&!r&&(t.value.addTo(o.value),r=!0),e.length===n.expectedLayers){const l=new S.LatLngBounds([]);for(const p of e)p.getBounds?l.extend(p.getBounds()):p.getLatLng&&l.extend(p.getLatLng());a("update:bounds",e.length>0?l:null)}};t.value.on("layeradd",d),t.value.on("layerremove",d),_(()=>{o.value&&o.value.hasLayer(t.value)&&o.value.removeLayer(t.value)})}};function X(n,a,o,r,t,d){return Q(n.$slots,"default")}const f=D(O,[["render",X]]);O.__docgenInfo={displayName:"FSMapMarkerClusterGroup",exportName:"default",description:"",tags:{},props:[{name:"expectedLayers",type:{name:"number"},required:!1,defaultValue:{func:!1,value:"0"}},{name:"disableClusteringAtZoom",type:{name:"number"},required:!1,defaultValue:{func:!1,value:"17"}}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/foundation-shared-ui/foundation-shared-ui/src/shared/foundation-shared-components/components/map/FSMapMarkerClusterGroup.vue"]};const Ke={title:"Shared/Components/Map",component:c,tags:["autodocs"],argTypes:{...j(c),currentLayer:{control:"select",options:[s.Map,s.Imagery,s.Snow]},overlayMode:{control:"select",options:[u.Expand,u.Half,u.Collapse]}}},b=[{id:"3fb7ebf0-3227-4767-bb96-001384efdd57",label:"Le Mans GERAL",address:{formattedAddress:"Bd Marie et Alexandre Oyon, 72100 Le Mans, France",locality:"Le Mans",country:"France",latitude:47.9946047,longitude:.1907672,placeId:"EjJCb3VsZXZhcmQgTWFyaWUgZXQgQWxleGFuZHJlIE95b24sIExlIE1hbnMsIEZyYW5jZSIuKiwKFAoSCZdY4sE2j-JHEfQHbY7RQXwpEhQKEgkxqvMU0ojiRxF_4H1qTF0CaQ",placeLabel:"Boulevard Marie et Alexandre Oyon, Le Mans, France"},icon:null,color:null},{id:"83963f32-6bd5-453d-b271-2b5a41672966",label:"Dative GPI",icon:"mdi-laptop",color:"#FF0000",address:{formattedAddress:"100 rue de norvège, Colombier Saugnieu, France",locality:"Colombier Saugnieu",country:"France",latitude:45.71175,longitude:5.071489,placeId:"",placeLabel:"Dative, France"}},{id:"44e00e4b-ef50-4f88-9fb2-d94659ee5881",label:"Gerard Perrier Industrie",icon:"mdi-home",color:"primary",address:{formattedAddress:"160 rue de norvège, Colombier Saugnieu, France",locality:"Colombier Saugnieu",country:"France",latitude:45.71129,longitude:5.071729,placeId:"",placeLabel:"GPI, France"}},{id:"4a3ced7a-d7e7-4004-b40a-ed57fa45615d",label:"Seirel Automatismes SAS",icon:"mdi-snowflake",color:"#FF0000",address:{formattedAddress:"7 Rue Galilée, 69800 Saint-Priest, France",locality:"Saint-Priest",country:"France",latitude:45.682349,longitude:4.956942,placeId:"",placeLabel:"Seirel, France"}},{id:"0598187c-3c63-413c-bc82-86c279027955",label:"D.E.S. FRIUL DI MIEC",address:{formattedAddress:"Via Ermes di Colloredo, 33040 Salt UD, Italie",locality:"Salt",country:"Italie",latitude:46.1158765,longitude:13.2881119,placeId:"EjBWaWEgRXJtZXMgZGkgQ29sbG9yZWRvLCBQb3ZvbGV0dG8sIFVkaW5lLCBJdGFsaWUiLiosChQKEgl_rhjEJEp6RxGWfpMrWhzPkBIUChIJn70qOztKekcRlT3jhsw1_cY",placeLabel:"Via Ermes di Colloredo, Povoletto, Udine, Italie"}}],g={args:{overlayMode:u.Collapse,currentLayer:s.Map,height:"100%",width:"100%",grayscale:!1,showMyLocation:!0,showZoomButtons:!0,enableScrollWheelZoom:!0},render:n=>H({components:{FSMap:c,FSRow:W,FSMapMarker:m},inheritAttrs:!1,setup(){const a=i(b[0]);return{args:n,location:a,onNewClick:r=>{console.log(r),a.value.address.latitude=r.lat,a.value.address.longitude=r.lng}}},template:`
      ...
      `})},v={args:{currentLayer:s.Imagery,overlayMode:u.Half},render:n=>({components:{FSMap:c,FSFadeOut:V,FSRow:W,FSCol:J,FSMapMarker:m,FSMapMarkerClusterGroup:f},setup(){const a=i(null);return{args:n,locations:b,bounds:a}},template:`
      <FSMap
        v-model:overlayMode="args.overlayMode"
        v-model:currentLayer="args.currentLayer"
        v-model:selectedLocationId="args.selectedLocationId"
...
}`,...(A=(Z=y.parameters)==null?void 0:Z.docs)==null?void 0:A.source}}};var E,B,$;F.parameters={...F.parameters,docs:{...(E=F.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    enableScrollWheelZoom: true
  },
  render: args => ({
...
}`,...($=(B=F.parameters)==null?void 0:B.docs)==null?void 0:$.source}}};const Te=["SingleLocationMap","MultiLocationMap","CustomPinMap","ClickablePinMap","GeneratePinMap"];export{y as ClickablePinMap,M as CustomPinMap,F as GeneratePinMap,v as MultiLocationMap,g as SingleLocationMap,Te as __namedExportsOrder,Ke as default};
