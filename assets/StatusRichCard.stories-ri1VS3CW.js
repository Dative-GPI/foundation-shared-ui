import{d as Y,c as u,E as g,H as n,_ as Z,K as h,L as w,M as b,k as C,N as F,O as y,S as B,U as O,V as $}from"./vue.esm-bundler-C5-CUMHT.js";import{F as ee}from"./FSCard-DYe1QD8j.js";import{F as o}from"./FSChip-PSYJcPlU.js";import{F as te}from"./FSText-C8rmUTxK.js";import{F as Q}from"./FSRow-C8aYwBu-.js";import{F as W}from"./FSCol-DedFW0nl.js";import{u as ae,C as x}from"./useColors-BAnxS_-e.js";import{_ as re}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{F as l}from"./FSIcon-CNpmwcOd.js";import"./FSRouterLink-CMTOFxCD.js";import"./vue-router-Bg3goQnP.js";import"./css-DSFbdPon.js";import"./useBreakpoints-pPMhsL5T.js";import"./VProgressCircular-D7Gk7a1O.js";import"./color-D7ZCcSxD.js";import"./theme-CB6As9Cd.js";import"./useRender-_COxrB9K.js";import"./intersectionObserver-D1RZdbEq.js";import"./resizeObserver-hE1ulDL8.js";import"./size-DwliOKuO.js";import"./tag-enhOFdJJ.js";import"./FSSpan-D6aG51_c.js";import"./useSlots-ol4Nk6ew.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./VIcon-IlEzlDWp.js";import"./icons-CucLNLjN.js";const X=Y({name:"FSStatusRichCard",components:{FSCard:ee,FSIcon:o,FSText:te,FSRow:Q,FSCol:W},props:{height:{type:[Array,String,Number],required:!1,default:"100px"},width:{type:[Array,String,Number],required:!1,default:"160px"},padding:{type:[Array,String,Number],required:!1,default:"12px"},gap:{type:[Array,String,Number],required:!1,default:"8px"},title:{type:[String,null],required:!1,default:null},titleClamp:{type:Number,required:!1,default:2},color:{type:[String,null],required:!1,default:null},fillBackground:{type:Boolean,required:!1,default:!1},modelStatus:{type:Object,required:!0},statusGroup:{type:Object,required:!0}},setup(e){const{getColors:t}=ae(),i=u(()=>{var a,r;return e.color??((a=e.statusGroup)==null?void 0:a.color)??((r=e.modelStatus)==null?void 0:r.colorDefault)??x.Primary}),v=u(()=>{var a,r;return((a=e.statusGroup)==null?void 0:a.icon)??((r=e.modelStatus)==null?void 0:r.iconDefault)??null}),T=u(()=>{var a;return e.title??((a=e.modelStatus)==null?void 0:a.label)??""}),k=u(()=>{var a,r,q,R,D,G;return(a=e.statusGroup)!=null&&a.label?e.statusGroup.label:(r=e.statusGroup)!=null&&r.value&&!isNaN(parseFloat((q=e.statusGroup)==null?void 0:q.value))?`${parseFloat(e.statusGroup.value).toLocaleString("fullwide",{maximumFractionDigits:2})} ${e.statusGroup.unit}`:(R=e.statusGroup)!=null&&R.value?`${(D=e.statusGroup)==null?void 0:D.value} ${(G=e.statusGroup)==null?void 0:G.unit}`:null}),d=u(()=>({"--fs-status-rich-card-background-color":e.fillBackground?t(i.value).light:"transparent","--fs-status-rich-card-border-color":e.fillBackground?t(i.value).base:t(x.Light).dark}));return{color:i,style:d,title:T,value:k,icon:v}}});function ne(e,t,i,v,T,k){const d=w("FSText"),a=w("FSCard");return e.$props.modelStatus?(b(),g(a,{key:0,class:"fs-status-rich-card",topRightPadding:"2px",variant:"standard",padding:e.$props.padding,height:e.$props.height,width:e.$props.width,color:e.color,style:Z(e.style)},{"top-right":n(()=>[B(e.$slots,"corner",O($({color:e.color})))]),default:n(()=>[C(W,{align:"center-center",gap:e.$props.gap},{default:n(()=>[C(Q,{align:"top-center"},{default:n(()=>[e.icon?(b(),g(l,{key:0},{default:n(()=>[F(y(e.icon),1)]),_:1})):h("",!0),e.value?(b(),g(d,{key:1,font:"text-button"},{default:n(()=>[F(y(e.value),1)]),_:1})):h("",!0)]),_:1}),C(d,{font:"text-overline",align:"center",lineClamp:e.$props.titleClamp},{default:n(()=>[F(y(e.title),1)]),_:1},8,["lineClamp"]),B(e.$slots,"footer",O($({color:e.color})))]),_:3},8,["gap"])]),_:3},8,["padding","height","width","color","style"])):h("",!0)}const s=re(X,[["render",ne]]);X.__docgenInfo={displayName:"FSStatusRichCard",exportName:"default",description:"",tags:{},props:[{name:"height",type:{name:"string[] | number[] | string | number | null"},required:!1,defaultValue:{func:!1,value:'"100px"'}},{name:"width",type:{name:"string[] | number[] | string | number | null"},required:!1,defaultValue:{func:!1,value:'"160px"'}},{name:"padding",type:{name:"string[] | number[] | string | number | null"},required:!1,defaultValue:{func:!1,value:'"12px"'}},{name:"gap",type:{name:"string[] | number[] | string | number | null"},required:!1,defaultValue:{func:!1,value:'"8px"'}},{name:"title",type:{name:"string | null"},required:!1,defaultValue:{func:!1,value:"null"}},{name:"titleClamp",type:{name:"number"},required:!1,defaultValue:{func:!1,value:"2"}},{name:"color",type:{name:"string | null"},required:!1,defaultValue:{func:!1,value:"null"}},{name:"fillBackground",type:{name:"boolean"},required:!1,defaultValue:{func:!1,value:"false"}},{name:"modelStatus",type:{name:"FSModelStatus | undefined"},required:!0},{name:"statusGroup",type:{name:"FSDeviceStatusGroup | undefined"},required:!0}],slots:[{name:"footer",scoped:!0,bindings:[{name:"color",title:"binding"}]},{name:"corner",scoped:!0,bindings:[{name:"color",title:"binding"}]}],sourceFiles:["/home/runner/work/foundation-shared-ui/foundation-shared-ui/src/shared/foundation-shared-components/components/deviceOrganisations/FSStatusRichCard.vue"]};const Oe={title:"Shared/Components/StatusRichCard",component:s,tags:["autodocs"],argTypes:{}},m={args:{modelStatus:{id:"1",label:"Status label that should clamp after two lines",index:1,showDefault:!1},statusGroup:{label:"",value:"70",unit:"°C",icon:"mdi-thermometer",color:"#E01515",sourceTimestamp:1726547886e3,enqueuedTimestamp:1726547952e3,processedTimestamp:1726547958156},title:void 0,titleClamp:2,fillBackground:!1},render:(e,{argTypes:t})=>({components:{FSStatusRichCard:s,FSChip:o,FSIcon:l},props:Object.keys(t),setup(){return{args:e}},template:`
      <FSStatusRichCard
        v-bind="args"
      ...
      <FSStatusRichCard
        v-bind="args"
        @click
      />`})};var N,j,I;m.parameters={...m.parameters,docs:{...(N=m.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    modelStatus: {
      id: '1',
...
}`,...(I=(j=m.parameters)==null?void 0:j.docs)==null?void 0:I.source}}};var V,E,_;c.parameters={...c.parameters,docs:{...(V=c.parameters)==null?void 0:V.docs,source:{originalSource:`{
  args: {
    modelStatus: {
      id: '1',
      label: 'Status label',
...
}`,...(_=(E=c.parameters)==null?void 0:E.docs)==null?void 0:_.source}}};var A,P,L;p.parameters={...p.parameters,docs:{...(A=p.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    modelStatus: {
      id: '1',
      label: 'Status label',
...
}`,...(L=(P=p.parameters)==null?void 0:P.docs)==null?void 0:L.source}}};var z,M,H;f.parameters={...f.parameters,docs:{...(z=f.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
    modelStatus: {
      id: '1',
      label: 'Status label',
...
}`,...(H=(M=f.parameters)==null?void 0:M.docs)==null?void 0:H.source}}};var K,U,J;S.parameters={...S.parameters,docs:{...(K=S.parameters)==null?void 0:K.docs,source:{originalSource:`{
  args: {
    modelStatus: {
      id: '1',
      label: 'Status label',
...
}`,...(J=(U=S.parameters)==null?void 0:U.docs)==null?void 0:J.source}}};const $e=["Default","Footer","Corner","Clickable","OtherClickable"];export{f as Clickable,p as Corner,m as Default,c as Footer,S as OtherClickable,$e as __namedExportsOrder,Oe as default};
