...
export function mockApp() {
    ...
    onGetWithRegex("/api/foundation/shared/v1/legal-informations/current", LEGAL_INFORMATIONS);
    ...
    onGetWithRegex("/api/foundation/core/v1/organisations/dative/user-organisation-tables/dashboardsExplorer1", USERORGANISATIONTABLES[21]);
    ...
    onGetWithRegex("/api/foundation/core/v1/organisations/dative/user-organisations/current", CURRENT_USERORGANISATION);
    ...
    onGetWithRegex("/api/foundation/core/v1/organisations/dative/dashboard-explorer-elements", DASHBOARDEXPLORERELEMENTS);
