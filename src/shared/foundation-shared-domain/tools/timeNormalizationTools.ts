...
export const getPeriodDuration = (periodStart: string | undefined, periodEnd: string | undefined): number => {
...
export const getTimeframeDuration = (timeframe: TimeComparisonType, periodStart: string | null = null, periodEnd: string | null = null): number => {
    switch (timeframe) {
